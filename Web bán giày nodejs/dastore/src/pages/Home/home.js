...
import banner2 from "../../assets/image/banner/banner1.jpg";
    ...
    useEffect(() => {
        (async () => {
            ...
            try {
                ...
                const response = await productApi.getProductsByCategory(data, "67fb676fb48d274f26674d78");
                console.log(response);
                setProductsPhone(response.data.docs);
                const response2 = await productApi.getProductsByCategory(data, "67fb676fb48d274f26674dd8");
                console.log(response2);
                setProductsPC(response2.data.docs);
                const response3 = await productApi.getProductsByCategory(data, "67fb679ab48d274f26674de0");
                console.log(response3);
                setProductsPhone(response3.data.docs);
                const response4 = await productApi.getProductsByCategory(data, "67fb67b3b48d274f26674de4");
                console.log(response4);
                setProductsPC(response4.data.docs);
                const response5 = await productApi.getProductsByCategory(data, "67fb67d0b48d274f26674de8");
                console.log(response5);
                setProductsPC(response5.data.docs);
            } catch (error) {
                console.log(error);
            }
        })();
        ...
        <Spin spinning={false}>
            ...
            <div style={{ background: "#FFFFFF", overflowX: "hidden", overflowY: "hidden", paddingTop: 15, }} className="home">
                    ...
                    <Row justify="center" align="top" key="1" >
                        ...
                        <Col span={19}>
                            <Carousel autoplay className="carousel-image">
                                <div className="img">
                                    <img style={{ width: '100%', height: 380 }} src={banner} alt="" />

                                </div>
                                <div className="img">
                                    <img style={{ width: '100%', height: 380 }} src={banner2} />
                                    ...
                                    <Badge.Ribbon text="Giảm giá" color="red" >
                                        <Card className="card_product" onClick={() => handleReadMore(item._id)}>
                                            ...
                                            <div className="support_product">
                                                Thu cũ giày cu - Giá thu cao nhất - Tặng thêm 1 triệu khi đổi giày cũ
                                            </div>
                ...
                <div className="image-one" >
                    ...
                    <div className="texty-title">
                        <p>Sản Phẩm <strong style={{ color: "#3b1d82" }}>ĐẶC BIỆT</strong></p>
                    </div>
                ...
                <div class="container-home container">
                    <div className="sale-2">
                        <div class="banner-block-1 banner-block">
                            <img src="https://ananas.vn/wp-content/uploads/banner-phu%CC%A3_2m-600x320.jpg" alt="" />
                        ...
                        <div class="banner-block-2 banner-block">
                            <img src="https://ananas.vn/wp-content/uploads/IMG_9453_retouch-600x331.jpg" alt="" />
                            <div class="banner-content ">
                ...
                <div className="image-one" >
                    ...
                    <div className="texty-title">
                        <p>Sản Phẩm <strong style={{ color: "#3b1d82" }}>MỚI 2023</strong></p>
                    </div> */}
                    ...
                    <OverPack style={{ overflow: 'hidden', height: 800, marginTop: 20 }} >
                        ...
                        >
                            ...
                            <div className="texty-title-footer">
                                <p>Tham Dự Buổi <strong>Ra Mắt Giày mới</strong></p>
                            </div>
